# Awesome OSINT Resources! 🕵️‍♀️✨
Below is the enriched OSINT section structure and some enhancements for readability. This makes your curated list both user-friendly and engaging. 🎉

## 🧙‍♂️ Awesome OSINT Tools and Resources
A curated list of tools and resources for Open Source Intelligence (OSINT), catering to both beginners and advanced users in Cyber Threat Intelligence (CTI), threat hunting, or OSINT.
...
Inspired by i-intelligence’s OSINT Tools and Resources Handbook.

Want to contribute? Check the CONTRIBUTING.md in the GitHub repo!
